...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HomeState&&(identical(other.heroSize, heroSize) || other.heroSize == heroSize)&&(identical(other.showWelcome, showWelcome) || other.showWelcome == showWelcome)&&(identical(other.showContent, showContent) || other.showContent == showContent));
}
...
@override
String toString() {
  return 'HomeState(heroSize: $heroSize, showWelcome: $showWelcome, showContent: $showContent)';
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _HomeState&&(identical(other.heroSize, heroSize) || other.heroSize == heroSize)&&(identical(other.showWelcome, showWelcome) || other.showWelcome == showWelcome)&&(identical(other.showContent, showContent) || other.showContent == showContent));
}
